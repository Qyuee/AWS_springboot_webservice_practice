...
// @WebMvcTest의 경우 JPA가 동작하지 않음
// JPA까지 모두 테스트하는 경우 @SpringBootTest와 TestRestTemplate를 사용한다.
...
class PostsApiControllerTest {
    ...
    public void Posts_수정된다() throws Exception {
        ...
        PostsUpdateRequestDto updateRequestDto = PostsUpdateRequestDto.builder().title(expectedTitle).content(expectedContent).build();
